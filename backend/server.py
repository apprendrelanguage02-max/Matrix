...
@api_router.get("/procedures/subcategories")
async def get_procedure_subcategories():
    """Get all procedure subcategories."""
    return PROCEDURE_SUBCATEGORIES

@api_router.get("/procedures", response_model=PaginatedProcedures)
async def get_procedures(
    ...
    # Enrich with subcategory info and author
...
@api_router.get("/procedures/{procedure_id}", response_model=ProcedureOut)
...
@api_router.post("/procedures", response_model=ProcedureOut)
