...
import {
  ...
  UserCog, Edit, RefreshCw, Bell, UserCheck, UserX, Clock, DollarSign
} from "lucide-react";
  ...
  return (
    <div className="space-y-6" data-testid="prices-tab">
      <div className="bg-white border border-zinc-200 p-5">
        <h3 className="font-['Oswald'] text-lg font-bold uppercase mb-4">Ajouter un prix de reference au m²</h3>
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          ...
          <input type="number" value={form.price_per_sqm} onChange={e => setForm(f => ({...f, price_per_sqm: e.target.value}))}
            placeholder="Prix/m² (GNF) *" data-testid="price-ref-value"
            className="border border-zinc-300 px-3 py-2 text-sm focus:outline-none focus:border-[#FF6600]" />
          ...
          <table className="w-full text-sm" data-testid="price-ref-table">
            <thead>
              <tr className="bg-zinc-50 border-b border-zinc-200">
                ...
                <th className="px-4 py-2 text-left text-xs font-bold uppercase text-zinc-500">Prix/m² (GNF)</th>
