        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4 group">
              <img src={LOGO} alt="Matrix News" className="w-10 h-10 object-contain" />
              <span className="font-['Oswald'] text-lg font-bold uppercase tracking-widest text-white group-hover:text-[#FF6600] transition-colors">
                Matrix News
              </span>
            </Link>
            <p className="text-sm leading-relaxed mb-5 text-zinc-500">
              La plateforme média de référence en Guinée. Actualités, immobilier et services pour la communauté GIMO.
            </p>
            <div className="flex items-center gap-3">
              <a href="#" aria-label="Facebook" className="w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 hover:border-[#FF6600] hover:text-[#FF6600] transition-all">
                <Facebook className="w-3.5 h-3.5" />
              </a>
              <a href="#" aria-label="Twitter" className="w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 hover:border-[#FF6600] hover:text-[#FF6600] transition-all">
                <Twitter className="w-3.5 h-3.5" />
              </a>
              <a href="#" aria-label="Instagram" className="w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 hover:border-[#FF6600] hover:text-[#FF6600] transition-all">
                <Instagram className="w-3.5 h-3.5" />
              </a>
              <a href="#" aria-label="YouTube" className="w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 hover:border-[#FF6600] hover:text-[#FF6600] transition-all">
          ...
          {/* Colonne 2 : Rubriques */}
          <div>
            <h3 className="font-['Oswald'] text-sm font-bold uppercase tracking-widest text-white mb-4">
              Actualités
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span>Conakry, Guinée<br />
                  <span className="text-zinc-600 text-xs">Kaloum, Commune de Conakry</span>
                </span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#FF6600] flex-shrink-0" />
                <a href="tel:+224622000000" className="hover:text-[#FF6600] transition-colors">
                  +224 622 000 000
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#FF6600] flex-shrink-0" />
                <a href="mailto:contact@matrixnews.gn" className="hover:text-[#FF6600] transition-colors">
            ...
            <div className="mt-5 pt-4 border-t border-zinc-800">
              <Link to="/connexion" className="inline-block bg-[#FF6600] text-white text-xs font-bold uppercase tracking-wider px-4 py-2 hover:bg-[#CC5200] transition-colors">
                Espace rédacteur
              </Link>
            </div>
          </div>
